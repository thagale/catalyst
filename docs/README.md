...
- [Specs](./specs/README.md) — Durable home for specs, requirements, and mockups with a `draft → accepted` lifecycle (distinct from ADRs and `thoughts/`)
- [Architecture](./architecture.md) — Three-layer system, memory model, agent teams
